...
# Load data
```{r}
data.dir <- "/fs/ess/PAS1695/projects/HNSC/data/drake-output/"

exora <- read.csv(file.path(data.dir, "tcga_exora-with-taxonomy.csv"), stringsAsFactors = F)
clin <- read.csv(file.path(data.dir, "tcga_clinical.csv"), stringsAsFactors = F)

...
exora.p.hist$phylum <- factor(exora.p.hist$phylum, levels = c("Actinobacteria", "Apicomplexa", "Caudovirales", "Firmicutes", "Ortervirales", "Proteobacteria", "Streptophyta", "Other"))
...
ggsave(g, file = "../figures/fig1_stackedbar.png", dev = "png", width = 13, height = 13)
```
